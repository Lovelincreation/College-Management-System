...
const Notice = () => {
  ...
  const addNoticeHandler = (e) => {
    ...
    axios
      .post(`${baseApiURL()}/notice/addNotice`, formData, {
  ...
  const updateNoticeHandler = (e) => {
    ...
    axios
      .put(`${baseApiURL()}/notice/updateNotice/${id}`, formData, {
        headers: { "Content-Type": "multipart/form-data" },
      })
      .then((response) => {
        toast.dismiss();
            ...
            notice.map((item, index) => {
              return (
                ...
                >
                  ...
                  <img src={item.image} className="img-fluid w-[400px] h-[500px]" alt="Notice" />
