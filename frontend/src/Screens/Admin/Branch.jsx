...
const Branch = () => {
  ...
  return (
    <div className="w-full mx-auto mt-10 flex flex-col items-center mb-10 px-4 sm:px-6 md:px-10">
      <div className="flex flex-col sm:flex-row justify-between items-center w-full">
        <Heading title="Add Branch" />
        <div className="flex justify-end items-center w-full mt-4 sm:mt-0">
          <button
            className={`$ {selected === "add" && "border-b-2 "} border-blue-500 px-4 py-2 text-black rounded-sm mr-3 sm:mr-6`}
      ...
      {selected === "add" && (
        <div className="flex flex-col justify-center items-center w-full mt-8">
          ...
          <button
            className="mt-6 bg-blue-500 px-6 py-3 text-white rounded-md hover:bg-blue-600 transition"
