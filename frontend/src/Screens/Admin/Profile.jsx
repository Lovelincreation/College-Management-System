  ...
  {data && (
    <>
        ...
        {showPass && (
          ...
          >
            <input
              ...
              className="w-full px-3 py-1 border-2 border-blue-500 outline-none rounded mt-4"
            />
            <input
              type="password"
              value={password.new}
      ...
      <img
        ...
        alt="student profile"
        className="h-[200px] w-[200px] object-cover rounded-lg shadow-md mt-4 md:mt-0 md:ml-4 self-center md:self-start"
      />
    </>
  )}
</div>
