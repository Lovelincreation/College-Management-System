...
const Profile = () => {
  ...
  return (
    <div className="w-full mx-auto my-8 flex flex-col md:flex-row justify-between items-start px-6">
  {data && (
    <>
      <div className="w-full md:w-1/2">
        ...
        <div className="mt-3">
          ...
          <p className="text-lg font-normal mb-2">
            Enter Class:  {data.class}
          </p>
          <p className="text-lg font-normal mb-2">
            Enter College Id:  {data.collegeId}
          </p>
          <p className="text-lg font-normal mb-2">
        ...
        {showPass && (
          ...
          >
            <input
              ...
              className="px-3 py-1 border-2 border-blue-500 outline-none rounded mt-4 w-full"
            />
            <input
              type="password"
              value={password.new}
      ...
      <img
        ...
        alt="student profile"
        className="h-[240px] w-[240px] object-cover rounded-lg shadow-md mt-4 md:mt-0 md:ml-4"
      />
    </>
  )}
</div>
